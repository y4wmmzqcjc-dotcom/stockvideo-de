...
;(function(){var tries=0;function go(){tries++;if(window.admin&&typeof window.admin.showSection==="function"){try{window.admin.updateDashboard&&window.admin.updateDashboard()}catch(e){}try{window.admin.updateDashboard&&window.admin.updateDashboard()}catch(e){}return;}if(tries<40)setTimeout(go,200);}setTimeout(go,800)})();/*BOOTSTRAP_RERENDER*/
