...
;(function(){function tryRender(n){if(window.admin&&typeof window.admin.updateDashboard==="function"){var dc=document.getElementById('dashboardContent');if(dc&&dc.children.length>0)return;try{window.admin.updateDashboard();}catch(e){}return;}if(n>0)setTimeout(function(){tryRender(n-1)},200);}setTimeout(function(){tryRender(10)},200);})();/*ROBUST_RERENDER*/
